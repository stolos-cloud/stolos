...
const docTemplate = `{
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "additionalProperties": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/api.NamespaceResponse"
                                }
                            }
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AddUserToNamespaceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/templates/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "name of the scaffold directory. see scaffolds API to list available options.",
                        "name": "scaffoldName",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "name of the template directory to create.",
                        "name": "templateName",
                        "in": "query",
                        "required": true
                    }
        ...
        "/templates/{id}/apply/{instance_name}": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "deploy to which namespace",
                        "name": "namespace",
                        "in": "query",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "handlers.AddUserToNamespaceRequest": {
            "type": "object",
            "required": [
                "user_id"
            ],
